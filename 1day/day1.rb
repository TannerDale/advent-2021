...
puts 'Part 1:'
puts "Practice: #{part_1(prac_input)}"
puts "Solution: #{part_1(input)}"
...
def part_2(input)
  group_sums = input.each_cons(3).map(&:sum)

  group_sums[1..].each_with_index.count do |num, i|
    num > group_sums[i]
  end
end

puts 'Part 2:'
puts "Practice: #{part_2(prac_input)}"
puts "Solution: #{part_2(input)}"
